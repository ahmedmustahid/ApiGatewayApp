...
public class CHATRatingsPredictorClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "CHATRatingsPredictorClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:CHATRatingsPredictorClient = {
        ...
        return CHATRatingsPredictorClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = CHATRatingsPredictorClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `CHATRatingsPredictorClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> CHATRatingsPredictorClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         CHATRatingsPredictorClient.registerClient(withConfiguration: configuration, forKey: "USWest2CHATRatingsPredictorClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = CHATRatingsPredictorClient.client(forKey: "USWest2CHATRatingsPredictorClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(CHATRatingsPredictorClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> CHATRatingsPredictorClient {
		objc_sync_enter(self)
		if let client: CHATRatingsPredictorClient = _serviceClients.object(forKey: key) as? CHATRatingsPredictorClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			CHATRatingsPredictorClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! CHATRatingsPredictorClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://2b58rav198.execute-api.ap-northeast-1.amazonaws.com/ios_connect"
    ...
    /*
     ...
     return type: Empty
     */
    public func predictedRatingsUserIdGet(userId: String) -> AWSTask<Empty> {
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/predicted-ratings/{user_id}", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: Empty.self) as! AWSTask<Empty>
	}
